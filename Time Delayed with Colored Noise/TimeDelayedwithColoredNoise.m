...
for i=1:Bushu+5
    ...
    p11(:,:,i+1)=fai0*p12(:,:,i+1)'+fai1*p13(:,:,i+1)'+fai2*p110(:,:,i+1)-gama*S1*k1(:,i+1)'*fai0'-gama*S1*k1pp(:,i+1)'*fai1'-gama*S1*k1pp2(:,i+1)'*fai2'+gama*pw1(i+1)*gama';
...
for i=1:Bushu+5
    ...
    p21(:,:,i+1)=fai0*p22(:,:,i+1)'+fai1*p23(:,:,i+1)'+fai2*p210(:,:,i+1)-gama*S2*k2(:,i+1)'*fai0'-gama*S2*k2pp(:,i+1)'*fai1'-gama*S2*k2pp2(:,i+1)'*fai2'+gama*pw2(i+1)*gama';
...
for i=1:Bushu+5
    ...
    p31(:,:,i+1)=fai0*p32(:,:,i+1)'+fai1*p33(:,:,i+1)'+fai2*p310(:,:,i+1)-gama*S3*k3(:,i+1)'*fai0'-gama*S3*k3pp(:,i+1)'*fai1'-gama*S3*k3pp2(:,i+1)'*fai2'+gama*pw3(i+1)*gama';
