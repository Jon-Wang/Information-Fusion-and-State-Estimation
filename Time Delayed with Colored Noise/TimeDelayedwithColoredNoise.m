...
B1=0.8;B2=0.6;B3=0.7;
Qxi1=1;Qxi2=2;Qxi3=3;Qw=0.8;
...
% gama=[1;-0.5];
% h01=[1 1];h11=[0 2];h21=[1 0.5];h31=[0 0];
% h02=[0.1 0];h12=[1 1];h22=[0.4 0.8];h32=[0 0];
% h03=[1.2 0];h13=[0.6 0];h23=[0 0];h33=[0 0];

fai0=[0.1 0.6;0 0.6];fai1=[0.61 -0.05;0 0.61];fai2=[0.4 0.6;-0.1 -0.5];
% fai0=[0.65 0.1;-0.1 0.5];fai1=[-0.1 0.4;0 -0.1];fai2=[0.4 0.6;0 0.5];
gama=[1.4;-1.2];
h01=[1 1];h11=[0 1];h21=[0.4 0.8];h31=[0 0];
h02=[1.3 0.9];h12=[0.1 0];h22=[0.1 0.8];h32=[0 0];
h03=[1.5 0.9];h13=[0.6 1];h23=[0.1 1];h33=[0 0];
