...
%-------------------系统模型-------------------%
% fai0=[0.8 0;0.1 -0.5];fai1=[-0.4 0;0.6 0.5];fai2=[0.4 -0.6;0 0.5];%原
% fai0=[0.8 0.1;0 -0.5];fai1=[-0.6 0;0.2 0.5];fai2=[0.4 0.6;0 0.5]; %可行
fai0=[0.8 0.4;0 0.6];fai1=[0.6 0.2;0 0.5];fai2=[0.4 0.6;0 -0.5];
gama=[2;-0.7];
% H01=[1 0];H11=[0 2];H21=[1 0.5];
% H02=[0 0];H12=[1 1];H22=[0.4 0.8];%论文上
% H03=[1.5 0];H13=[0.6 1];H23=[0 0];

% H01=[4 1];H11=[0 1];H21=[1 1];
% H02=[5 0.9];H12=[1 1];H22=[0.4 0.8];%原
% H03=[5 0.8];H13=[0.6 1];H23=[0 0];

H01=[4 1];H11=[0 1];H21=[1 4];
